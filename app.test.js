...
describe("Tests for app.js, in particular the GET, POST and DELETE requests associated with the routes", () => {
      ...
      test('As before, assuming albums have previously been posted  there will, following an GET request to /albums, be a response in JSON format', () => {
          return request(server)
          .get('/albums')
